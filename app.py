...
APP_TITLE = "Jakarta Air Quality Sky Observatory"
APP_SUBTITLE = (
    "Membaca lapisan udara Jakarta seperti lanskap langit: kondisi terkini, "
    "sinyal risiko, lokasi prioritas, pencemar dominan, periode rawan, dan kepercayaan data."
)
        ...
        <div class="command-hero" aria-label="Observatorium kualitas udara Jakarta dengan nuansa langit senja pastel">
            <div class="hero-grid">
                <div>
                    ...
                    <div class="pill-row">
                        <div class="pill">Garis senja risiko: ISPU 101</div>
...
def main() -> None:
    ...
    st.markdown("---")
    st.caption(
        "Dashboard BI ISPU DKI Jakarta · Tema Sky Observatory: langit, awan, dedaunan, dan sinyal risiko kualitas udara untuk keputusan berbasis data."
    )
